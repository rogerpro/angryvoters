	...
	<div id="content">
		<div class="row">
			...
			<div class="columns large-12 checks">
                ...
                <?php else: ?>
                    <p class="problem">
					CakePHP is NOT able to connect to the database.<br /> <br /><?= $errorMsg ?></p>
                <?php endif; ?>
                ...
                <?php else: ?>
                    <p class="problem">DebugKit is NOT loaded. You need
		...
		<div class="row">
			<div class="columns large-12">
				...
				<ul>
					...
					<li><a href="http://discourse.cakephp.org/">CakePHP Forum</a>
						<ul>
				...
				<ul>
					...
					<li><a href="https://github.com/FriendsOfCake/awesome-cakephp">CakePHP
							Awesome List</a>
						<ul>
							<li>A curated list of amazingly awesome CakePHP plugins,
								resources and shiny things.</li>
						</ul></li>
